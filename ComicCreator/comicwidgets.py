...
class DraggableWidget(RelativeLayout):
    ...
    def on_touch_move(self, touch):
        ...
        if self.selected and self.parent.collide_point(x - self.width/2, y - self.height/2):  #make sure we dont get out of space we have
    ...
    #unselect when we finish touching
